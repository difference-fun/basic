<?php
namespace Package\Difference\Fun\Basic\Trait;
...
trait Main {
    ...
    public function apache2_site_create($options=[]): void
    {
        ...
        if ($object->config(Config::POSIX_ID) !== 0) {
            ...
            Event::trigger($object, 'difference.fun.basic.configure.apache2.site.create', [
                'options' => $options,
                'exception' => $exception
            ]);
            throw $exception;
    ...
    public function apache2_site_has($options=[]): bool
    {
        ...
        if ($object->config(Config::POSIX_ID) !== 0) {
            ...
            Event::trigger($object, 'difference.fun.basic.configure.apache2.site.enable', [
                'options' => $options,
                'exception' => $exception
            ]);
            throw $exception;
    ...
    public function apache2_site_disable($options=[]): void
    {
        ...
        if ($object->config(Config::POSIX_ID) !== 0) {
            ...
            Event::trigger($object, 'difference.fun.basic.configure.apache2.site.disable', [
                'options' => $options,
                'exception' => $exception
            ]);
            throw $exception;
    ...
    public function openssl_init($flags, $options): void
    {
        ...
        if ($object->config(Config::POSIX_ID) !== 0) {
            ...
            Event::trigger($object, 'difference.fun.basic.configure.openssl.init', [
                'options' => $options,
                'exception' => $exception
            ]);
            throw $exception;
